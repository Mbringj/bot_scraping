# bot course 
## telegram python bot use case 

1 - The first one we go to generate your bot key in @fatherBot
I recommand you to use .env file configuration 
